...
#open(INPUT, "/media/G3data/fdr/trans/g3alpha_model_results1_gt2.4trans.txt") or die "cannot open file\n";
open(INPUT, "../../g3alpha_model_results1_transhg18_gt2.4.txt") || die "cannot open file\n";
my %genemarker=();
