...
sub run_comp_corrected_peaks2{
	...
	load_ref_blocks2(\%ref,
		...
		"/media/G3data/fdr18/trans/zero_gene_peaks/NEW/simulation/zero_gene_cgh_ucsc+miRNA_ranges300kb.txt",
		\%filestruct);
...
# zero-gene-markers(deserts). Modified to take filename as arg.
#run_comp_corrected_peaks2();
#run_comp_corrected_peaks2("/media/G3data/fdr18/trans/zero_gene_peaks/NEW/unique/zero_gene_peaks2_FDR25_ranges300k.txt");
run_comp_corrected_peaks2($ARGV[0]);
