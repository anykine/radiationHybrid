...
sub run_comp_mus_wold{
	...
	load_ref_blocks(\%musblocks,
								"/media/G3data/fdr18/trans/zero_gene_peaks/mouse/unique/zero_gene_peaks2_ranges300k_FDR30.txt", 
							 \%filestruct);
...
sub run_lincRNAmus_Woldmus{
	my %comp = ();
	load_comp_data(\%comp, "./20100909mus_wold_overlap.txt");
	my %ref = ();
	my %filestruct=(startchrom=>0,startpos=>1,endpos=>2);
	load_ref_blocks(\%ref,
	             "./20100909mus_lincRNA_overlap.txt",
							 \%filestruct);
	overlap_ref_comp(\%ref, \%comp);
}
...
sub run_lincRNAhum_Woldhum{
	my %comp = ();
	load_comp_data(\%comp, "./20100909humpeak3_lincRNA_overlap.txt");
	my %ref = ();
	my %filestruct=(startchrom=>0,startpos=>1,endpos=>2);
	load_ref_blocks(\%ref,
	             "./20100909humpeak3_wold_overlap.txt",
							 \%filestruct);
	overlap_ref_comp(\%ref, \%comp);
}
...
sub run_lincRNAhum_ultraconshum{
	...
	my %filestruct=(startchrom=>0,startpos=>1,endpos=>2);
	load_ref_blocks(\%ref,
	             "./20100909humpeak3_ultracons_overlap.txt",
							 \%filestruct);
	overlap_ref_comp(\%ref, \%comp);
}
...
sub run_woldhum_ultraconshum{
	my %comp = ();
	load_comp_data(\%comp, "./20100909humpeak3_wold_overlap.txt");
	my %ref = ();
	my %filestruct=(startchrom=>0,startpos=>1,endpos=>2);
	load_ref_blocks(\%ref,
	             "./20100909humpeak3_ultracons_overlap.txt",
...
sub run_lincRNAhum_Woldhum_lincRNAhum_ultraconshum{
	my %comp = ();
	load_comp_data(\%comp, "20100909linchum_woldhum_overlap.txt");
	my %ref = ();
	my %filestruct=(startchrom=>0,startpos=>1,endpos=>2);
	load_ref_blocks(\%ref,
							"./20100909linchum_ultraconshum_overlap.txt",
							 \%filestruct);
	overlap_ref_comp(\%ref, \%comp);
}
...
sub run_lincRNAmus_ultraConsmus{
	my %comp = ();
	load_comp_data(\%comp, "./20100909mus_lincRNA_overlap.txt");
	my %ref = ();
	my %filestruct=(startchrom=>0,startpos=>1,endpos=>2);
	load_ref_blocks(\%ref,
	             "./20100909mus_ultracons_overlap.txt",
							 \%filestruct);
	overlap_ref_comp(\%ref, \%comp);
}
...
sub run_lincRNAmus_Woldmus_lincRNAmus_ultraconsmus{
	my %comp = ();
	load_comp_data(\%comp, "20100909lincmus_woldmus_overlap.txt");
	my %ref = ();
	my %filestruct=(startchrom=>0,startpos=>1,endpos=>2);
	load_ref_blocks(\%ref,
							"./20100909lincmus_ultraconsmus_overlap.txt",
							 \%filestruct);
	overlap_ref_comp(\%ref, \%comp);
}
...
# compare renlab hum enhancer db against hum 0-gene blocks @ FDR30
sub run_comp_hum_ren{
	my %comp=();
	load_comp_data(\%comp, "../renlab/36589_enh_2500bp_hg18.txt");
	my %ref = ();
	my %filestruct=( startmarker=>0,startchrom=>1,startpos=>2,endmarker=>3,endchrom=>4,endpos=>5);
	load_ref_blocks(\%ref,
	             #"/media/G3data/fdr18/trans/zero_gene_peaks/NEW/unique/peaks3/zero_gene_peaks3_ranges300k.txt",
