...
int main(int argc, char *argv[]) {
	...
	char pcdh7_index_file[]="/home/josh/Desktop/symatlas_pcdh7/pcdh7_sym_id.txt";

	char pcdh7_avg[]="pcdh7_average_correlation.txt";
	...
	while (sampnum<10000){
		...
		pcdh7ind[sampsize]=(rand() % (symrows+1)); sampsize++; 
		while (sampsize<pcdh7count) {
			found=0;
			newrand=(rand() % (symrows+1));
