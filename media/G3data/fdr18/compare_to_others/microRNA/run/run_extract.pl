...
# to use for hairpin folding
sub get_mus_zerogene_seq{
	open(INPUT, "/media/G3data/fdr18/trans/zero_gene_peaks/mouse/unique/zero_gene_peaks_ranges300k.txt") || die "No mouse 0gene";
	my $id=1;
	my $curchrom = 1;
