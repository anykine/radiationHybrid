# NOTE: lowess data gives better separation between
#       male and female, so use those calls and
#       don't use this
# classify the samples as male/female based on X CGH
# chrom data
xdata = read.table("cgh.xonly1", header=T)
xdata.means = apply(xdata[,5:223], 2, mean, na.rm=T)
