...
#if defined FEMALE
	char cghfile[] = "../tcga_cghfemale_sm.sc.filt";
	char expr_file[] = "../tcga_exprfemale";
	// ouptut file
	char output_file[] = "regress_results1_female.txt_fdr";
	fprintf(stderr, "processing FEMALE\n");
#elif defined ALL
	char cghfile[] = "../tcga_cgh_sm.sc.filt";
	char expr_file[] = "../tcga_expr.txt";
	char output_file[] = "regress_results1_all.txt_fdr";
	fprintf(stderr, "processing ALL\n");
#else
	char cghfile[] = "../tcga_cghmale_sm.sc.filt";
	char expr_file[] = "../tcga_exprmale";
	// ouptut file
	char output_file[] = "regress_results1_male.txt_fdr";
