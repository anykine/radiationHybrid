...
#if defined FEMALE
	char cghfile[] = "../tcga_cghfemale_sm.sc.filtX_clin";
	char expr_file[] = "../tcga_exprfemale_clin";
	// ouptut file
	char output_file[] = "regress_results1_female.txt_clin";
...
#else
	char cghfile[] = "../tcga_cghmale_sm.sc.filtX_clin";
	char expr_file[] = "../tcga_exprmale_clin";
	// ouptut file
	char output_file[] = "regress_results1_male.txt_clin";
...
fprintf(stderr,"loading markers per gene\n");
	...
	fi = fopen("../within2mbX/cis_2mb.txt", "r");
	if (fi==NULL){
