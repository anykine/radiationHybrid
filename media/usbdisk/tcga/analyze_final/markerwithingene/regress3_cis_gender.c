...
#if defined FEMALE
	char cghfile[] = "hapmap_cghfemale_smoothed";
	char expr_file[] = "hapmap_exprfemale";
	// ouptut file
...
#else
	char cghfile[] = "hapmap_cghmale_smoothed";
	char expr_file[] = "hapmap_exprmale";
	// ouptut file
...
fprintf(stderr,"loading markers per gene\n");
	...
	int cismarkersfile= 4470;
	int cismarkers[cismarkersfile][2];
	fi = fopen("../cghmarkers_within_genes_unique.idx", "r");
	if (fi==NULL){
