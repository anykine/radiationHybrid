...
int main()
{
	...
	char upret_file[] = "/data0/QTL_c_code/alpha_model/input/for_C_scaled_cgh.txt";
	char downexp_file[] = "/data0/QTL_c_code/alpha_model/input/for_C_downstream_expression_log10.txt";
